...
abstract class Course
{
    ...
    public function getCourseBnr() { return $this->course_bnr; }
    public function setCourseBnr($course_bnr) { $this->course_bnr = $course_bnr; }
    public function getCertification() { return $this->certification; }
    public function setCertification($certification) { $this->certification = $certification; }
